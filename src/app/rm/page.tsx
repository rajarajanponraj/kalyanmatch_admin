...
export default async function RMPage() {
  ...
  // 2. Fetch Active RMs and Assignments
  const { count: totalRms } = await supabase
  ...
  // 4. Fetch Daily Activity Analytics
  ...
  return (
    <div className="space-y-8 animate-fade-in">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 border-b border-zinc-200 dark:border-zinc-800 pb-5">
        <div>
          <h2 className="text-3xl font-extrabold tracking-tight text-zinc-950 dark:text-white">RM Console</h2>
          <p className="text-zinc-500 dark:text-zinc-400 mt-1">Verification workflow and relationship assignments overview</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <div className="bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-2xl p-6 shadow-sm hover:shadow-md transition-all duration-300">
          <div className="flex justify-between items-start">
            <div className="space-y-2">
              <span className="text-xs font-bold text-zinc-400 dark:text-zinc-500 uppercase tracking-widest">Active RMs</span>
              <h3 className="text-3xl font-extrabold text-zinc-950 dark:text-white">{totalRms ?? 0}</h3>
            </div>
          ...
          <div className="flex items-center gap-2 mt-4 text-xs font-semibold text-zinc-500 dark:text-zinc-400">
            ...
            <span>Certified relationship managers</span>
          </div>
        </div>
        ...
        <div className="bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-2xl p-6 shadow-sm hover:shadow-md transition-all duration-300">
          <div className="flex justify-between items-start">
            <div className="space-y-2">
              <span className="text-xs font-bold text-zinc-400 dark:text-zinc-500 uppercase tracking-widest">Assigned Clients</span>
              <h3 className="text-3xl font-extrabold text-zinc-950 dark:text-white">{activeAssignments ?? 0}</h3>
            </div>
          ...
          <div className="flex items-center gap-2 mt-4 text-xs font-semibold text-zinc-500 dark:text-zinc-400">
            ...
            <span>RM-assisted premium users</span>
          </div>
        </div>
        ...
        <div className="bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-2xl p-6 shadow-sm hover:shadow-md transition-all duration-300">
          <div className="flex justify-between items-start">
            <div className="space-y-2">
              <span className="text-xs font-bold text-zinc-400 dark:text-zinc-500 uppercase tracking-widest">Pending Review</span>
              <h3 className="text-3xl font-extrabold text-zinc-950 dark:text-white">{pendingVerifications ?? 0}</h3>
            </div>
          ...
          <div className="flex items-center gap-2 mt-4 text-xs font-semibold text-zinc-500 dark:text-zinc-400">
            ...
            <span>ID and Selfie verifications</span>
          </div>
        </div>
      </div>
          ...
          <div className="space-y-4">
            <div className="flex items-center justify-between p-4 bg-zinc-50 dark:bg-zinc-950 rounded-xl border border-zinc-100 dark:border-zinc-900">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-zinc-400">Review pending govt ID uploads</p>
                </div>
              </div>
            ...
            <div className="flex items-center justify-between p-4 bg-zinc-50 dark:bg-zinc-950 rounded-xl border border-zinc-100 dark:border-zinc-900">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h5 className="text-sm font-semibold">Open Abuse Reports</h5>
                  <p className="text-xs text-zinc-400">User harassment & spam reports</p>
                </div>
              </div>
